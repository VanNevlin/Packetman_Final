...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (!isActivePlayer)
        {
            ...
            rb.gravityScale = 80f; //Boosted Gravity to compensate Vector2.Zero slowing down fall rate
        ...
        else if (isActivePlayer)
        {
          ...
          //  if(rb.velocity.x < -0.5 || rb.velocity.x > 0.5)
          //  {
               // animator.SetFloat("PlayerSpeed", Mathf.Abs(horizontal)); // Nevlin Testing Walking Animation Switch
          //  }
            animator.SetFloat("PlayerSpeed", Mathf.Abs(horizontal)); // Nevlin Testing Walking Animation Switch Bug
        }
